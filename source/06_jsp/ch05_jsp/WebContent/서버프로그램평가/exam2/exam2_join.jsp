...
<link href='../exam2/exam2_join.css' rel='stylesheet'>
<script>
	function chkJoin() {
...
<body>
	<div id="joinForm_wrap">
		<form action="../exam2joinPro" method="post" name="frmJoin" onsubmit="return chkJoin()">
			...
			<table>
				...
				<tr>
					...
					<td><input type="checkbox" name="hobby" value="독서"
						id="reading"> <label for="reading">독서</label> <input
	...
	<%@ include file="../exam2/exam2_footer.jsp" %>
</body>
</html>