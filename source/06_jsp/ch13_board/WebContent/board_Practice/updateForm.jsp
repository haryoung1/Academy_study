...
<body>
	...
	%>
	<form action="<%=conPath%>/board_Practice/updatePro.jsp" method="post">
		...
		<table>
			...
			<tr>
				<th>본문</th>
				<td>
					<textarea rows="5" name="content" required="required"><%=dto.getContent() %>
					</textarea>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2">
					...
					<input type="button" value="목록" class="btn" 
						onclick="location.href='<%=conPath %>/board_Practice/list.jsp'">
			</tr>
		</table>
	</form>
</body>
