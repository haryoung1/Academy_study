...
public class BoardDto2 {
	...
	public BoardDto2(int num, String writer, String subject, String content, String email, int readcount, String pw,
	...
	public String toString() {
		return "BoardDto2 [num=" + num + ", writer=" + writer + ", subject=" + subject + ", content=" + content
