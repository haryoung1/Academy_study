	...
	<div id="joinForm_wrap">
		...
		<table>
			<tr>
				...
				<td><input type="text" name="cid" autofocus="autofocus"></td>
			</tr>
			<tr>
				<th><label for="pw">비밀번호</label></th>
				<td><input type="password" name="cpw" autofocus="autofocus"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="date" name="cbirth" id="birth" class="birth"></td>
			</tr>
			<tr>
				<th>성별</th>
				<td>
