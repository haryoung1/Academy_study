...
<body>
	...
	<%
		String path = request.getRealPath("fileUpFolder"); // 첨부 할 파일이 저장될 서버(WAS) 폴더
		out.print(path);
		...
		try {
			...
			if(serverFile.exists()) {
				...
				os = new FileOutputStream("D:/webPro/source/06_jsp/ch14_fileUp/WebContent/fileUpFolder/" + filename); // 소스폴더로 복사 될 파일
