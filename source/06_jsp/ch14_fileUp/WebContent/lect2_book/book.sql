...
CREATE TABLE BOOK(
    ...
    bCONTENT VARCHAR2(4000),        -- 책 설명(varchar2는 4000이 최대, 그 이상은 clob 사용)
...
INSERT INTO BOOK (bID, bTITLE, bPRICE, bIMAGE1, bIMAGE2, bCONTENT, bDISCOUNT) 
    VALUES (BOOK_SEQ.NEXTVAL, 'Spring 짱', 30000, 'noImg.png', 'NOTHING.JPG', '프레임워크', 10);     
