...
//	-- 2. 글목록
	public ArrayList<BoardDto2> listBoard(){
		ArrayList<BoardDto2> dtos = new ArrayList<BoardDto2>();
		Connection        conn  = null;
		PreparedStatement pstmt = null;
		ResultSet         rs    = null;
		...
		try {
			...
			while(rs.next()) {
				...
				dtos.add(new BoardDto2(num, writer, subject, content, email, readcount, 
	...
	//	-- 2. 글목록
	public ArrayList<BoardDto2> listBoard(int startRow, int endRow){
		ArrayList<BoardDto2> dtos = new ArrayList<BoardDto2>();
		Connection        conn  = null;
		PreparedStatement pstmt = null;
		ResultSet         rs    = null;
...
//	-- 3. 원글쓰기 
	public int insertBoard(BoardDto2 dto) {
		int result = FAIL;
		Connection conn = null;
		PreparedStatement pstmt = null;
...
//	-- 4. 글번호로 글 내용(DTO) 가져오기
	public BoardDto2 getBoardOneLine(String numStr) {
		BoardDto2 dto = null;
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		...
		try {
			...
			if (rs.next()) {
				...
				String ip = rs.getString("ip");
				Timestamp rdate = rs.getTimestamp("rdate");
				dto = new BoardDto2(num, writer, subject, content, email, readcount, pw, ref, re_step, re_indent, ip,
						rdate);
			}
		} catch (SQLException e) {
			System.out.println(e.getMessage());
...
//	-- 4. 글번호로 글 내용(DTO) 가져오기
	public BoardDto2 getBoardOneLine(int num) {
		BoardDto2 dto = null;
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
...
//	-- 6. 글 수정
	public int updateBoard(BoardDto2 dto) {
		int result = FAIL;
		Connection conn = null;
		PreparedStatement pstmt = null;
