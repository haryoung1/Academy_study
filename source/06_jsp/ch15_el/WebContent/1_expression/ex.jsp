...
<body>
	...
	<p>산술 연산자 : 10/0.0 = <%=10/0.0 %></p> <!-- 0으로 나누면 에러, 0.0으로 나누면 가능 -->
	<p>관계 연산자 : 1  > 2 = <%=1>2 %> </p>
	<p>관계 연산자 : 1 == 2 = <%=1==2 %></p>
	<p>관계 연산자 : 1 != 2 = <%=1!=2 %></p>
	<p>조건 연산자 : <%=(1>2)? "1이 2보다 큽니다" : "1이 2보다 크지 않습니다" %></p>
	...
	<p>pageNum 파라미터 여부 : <%=request.getParameter("pageNum") == null? "pageNum 안옴":"pageNum옴" %></p>
