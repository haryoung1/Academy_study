	...
	<div id="content_form">
		<form action="${conPath }/boardReply.do" method="post" enctype="multipart/form-data">
			<!-- reply.do시 필요한 원글 정보 : bGroup, bStep, bIndent
			                        지금 입력할 답변글 : bName, bTitle, bContent  pageNum
			  -->
		...
		<table>
			...
			<tr>
				<td>제목</td>
				<td>
					<input type="text" name="ftitle" required="required" value="[답]${originBoard.ftitle }">
				</td>
			</tr>
			<tr>
				<td>본문</td>
				<td>
					<textarea rows="3" cols="3" name="fContent"></textarea>
				</td>
			</tr>
			<tr>
				<td>첨부파일</td>
