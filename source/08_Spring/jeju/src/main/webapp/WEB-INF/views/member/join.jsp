...
<!--  다음 주소 api -->
<script src="http://dmaps.daum.net/map_js_init/postcode.v2.js"></script> <script src="${conPath }/js/address.js"></script> 
<!--  다음 주소 api -->
<!--  <script>
  ...
  <body>
	<form action="${conPath }/member.do?method=join" method="post" enctype="multipart/form-data">
            <div id="border">
                <table>
					<tr><td class="join"><div>&nbsp;</div>JOIN</td></tr>                   
					<tr><td></td></tr>
                    <tr>
                        <td>아이디<b>*</b></td>
                    </tr>
