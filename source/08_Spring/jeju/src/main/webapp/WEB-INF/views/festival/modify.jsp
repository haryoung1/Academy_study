...
<body>
	...
	<form action="${conPath }/festvial/modify.do" method="post">
		...
		<table>
			...
			<tr>
				<th>작성자</th>
				<td><input type="text" name="bname" value="${festival.aid }"
					required="required" autofocus="autofocus"></td>
			</tr>
			<tr>
				<th>제목</th>
				<td><input type="text" name="btitle" value="${festival.ftitle }"
					required="required"></td>
			</tr>
			<tr>
				<th>본문</th>
				<td><textarea rows="5" name="bcontent">${festival.fcontent }</textarea></td>
			</tr>
			<tr>
