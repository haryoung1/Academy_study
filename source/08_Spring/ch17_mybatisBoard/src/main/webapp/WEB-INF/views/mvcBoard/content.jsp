...
<body>
	...
	<table>
		...
		<tr>
			<th>작성일</th>
			<td><fmt:formatDate value="${contentBoard.bdate }"
		...
		<tr>
			<td colspan="2">
				<button
					onclick="location.href='${conPath}/mvcBoard/modifyView.do?bid=${param.bid }&pageNum=${param.pageNum }'">
					수정</button>
				<button
					onclick="location.href='${conPath}/mvcBoard/delete.do?bid=${param.bid }&pageNum=${param.pageNum }'">
					삭제</button>
				<button
					onclick="location.href='${conPath}/mvcBoard/reply.do?bid=${param.bid}&pageNum=${param.pageNum }'">
					답변</button>
				<button
