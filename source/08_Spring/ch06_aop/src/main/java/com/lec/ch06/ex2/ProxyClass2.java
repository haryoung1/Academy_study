...
public class ProxyClass2 {
	// around advice : 핵심기능 전후 로 공통기능 수행
//	@Pointcut("within(com.lec.ch06.ex1.*)")
...
//	@Around("aoundM")
	...
	public Object aroundAdvice(ProceedingJoinPoint joinPoint) throws Throwable {
		...
		System.out.println(signatureName + "가 시작 되었습니다.");
	...
	public void beforeAdvice() {
		System.out.println("핵심기능 수행하기 전 beforeAdvice() 수행");
	}
	...
	// afterReturning advice : 핵심기능을 에러 없이 수행 후, 공통기능 수행
	@AfterReturning("within(com.lec.ch06.ex2.Worker2)")
	public void afterReturningAdvice() {
		System.out.println("핵심기능 에러없이 수행 후 afterReturningAdvice() 자동수행");
	}

	// afterThrowing advice : 핵심기능에 예외 발생 후 공통기능 수행
	@AfterThrowing("execution(void com.lec.ch06.ex2.Worker2.get*())")
	public void afterThrowingAdvice() {
		System.out.println("핵심기능 예외 발생 후 afterThrowingAdvice() 자동수행");
	}
}
