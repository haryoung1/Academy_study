...
<body>
	...
	<form action="${conPath }/student.do" method="get">
		ID : <input type="text" name="id"> <input type="submit" value="get 방식으로 보내기">
	</form>
	<h1>POST</h1>
	<form action="${conPath }/student.do" method="post">
		ID : <input type="text" name="id"> <input type="submit" value="post 방식으로 보내기">
	</form>
	<h1>
	...
	<form action="${conPath }/idConfirm.do" method="post">
		ID <input type="text" name="id"> <input type="submit" value="id confirm">
	</form>
	<hr>
