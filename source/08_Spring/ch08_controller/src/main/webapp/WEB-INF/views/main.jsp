...
<body>
	...
	<p>
		<a href="${conPath }/board/write">board의 write로 가기</a>
	</p>
	<p>
		<a href="${conPath }/board/content">board의 content로 가기</a>
	</p>
	<p>
		<a href="${conPath }/board/list">board의 list로 가기</a>
	</p>
	<p>
	...
	<p>
		<button onclick="location.href='${conPath}/member?method=infoModify'">정보수정</button>
	</p>
</body>
</html>